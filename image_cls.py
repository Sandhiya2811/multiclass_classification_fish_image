...
# Looks for the model file in the SAME folder as this script.
# Change this only if your .keras file lives somewhere else.
MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "densenet_model.keras")

@st.cache_resource
def get_model():
    if not os.path.exists(MODEL_PATH):
        st.error(f"❌ Model file not found at: {MODEL_PATH}\n\nMake sure 'densenet_model.keras' is in the same folder as this script, or update MODEL_PATH.")
        st.stop()
